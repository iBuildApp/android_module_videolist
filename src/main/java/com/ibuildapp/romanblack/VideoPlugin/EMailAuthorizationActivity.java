 ...
 */
public class EMailAuthorizationActivity extends AppBuilderModuleMain implements
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case NEED_INTERNET_CONNECTION: {
                    Toast.makeText(EMailAuthorizationActivity.this, getString(R.string.romanblack_video_alert_no_internet), Toast.LENGTH_LONG).show();
                }
                break;
                case FAILED_TO_LOGIN: {
                    Toast.makeText(EMailAuthorizationActivity.this, getString(R.string.romanblack_video_login_failed), Toast.LENGTH_LONG).show();
                }
                break;
                ...
                case EMAIL_NOT_MATCHES: {
                    Toast.makeText(EMailAuthorizationActivity.this, getString(R.string.romanblack_video_alert_email_invalid), Toast.LENGTH_LONG).show();
                }
                break;
            }
        }
