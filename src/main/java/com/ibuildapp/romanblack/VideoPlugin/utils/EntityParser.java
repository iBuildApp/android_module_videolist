...
public class EntityParser {
    ...
    public void parse() {
        ...
        Element isLightElement = colorSchemeElement.getChild("isLight");
        isLightElement.setEndTextElementListener(new EndTextElementListener() {
            public void end(String arg0) {
                isLight = Integer.parseInt(arg0.trim())>0;
            }
        });
